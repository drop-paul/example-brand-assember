possible_domains = {}
com_domain = namecheap action:check domain:brand_name + '.com'
io_domain = namecheap action:check domain:brand_name + '.io'
co_domain = namecheap action:check domain:brand_name + '.co'
net_domain = namecheap action:check domain:brand_name + '.net'
